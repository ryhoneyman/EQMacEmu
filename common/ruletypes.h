...
RULE_BOOL(Quarm, ClientFactionModifier, false, "Enables or disables client personal faction adjustment")
...
RULE_STRING(Quarm, ClientSpellDurationModifierList, "", "Player spell duration modification: ID:TIC,ID:TIC,ID:MULTIx,...")
...
RULE_STRING(Quarm, NPCSpellDurationModifierList, "", "NPC spell duration modification: ID:TIC,ID:TIC,ID:MULTIx,...")
RULE_CATEGORY_END()
RULE_CATEGORY( Map )
